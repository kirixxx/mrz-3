...
def train_eval_period(verbose: bool = False) -> Tuple[float, List[float]]:
    ...
    if verbose:
        draw_error_plot(errors_list=errors_list, title='Jordan-Elman model on periodical sequence errors')
...
def train_eval_exponent(verbose: bool = False) -> Tuple[float, List[float]]:
    ...
    if verbose:
        draw_error_plot(errors_list=errors_list, title='Jordan-Elman model on exponential sequence errors')
