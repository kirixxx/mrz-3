...
from modules.data.datasets import (FibonacciDataset,
                                   ...
                                   PeriodDataset,
                                   ExponentialDataset)
from modules.network.main import Elman_Jordan
...
def train_eval_fibonacci(verbose: bool = False) -> Tuple[float, List[float]]:
    ...
    network = Elman_Jordan(lr=Config.learning_rate,
    ...
    if verbose:
        draw_error_plot(errors_list=errors_list, title='Elman_Jordan model on fibonacci sequence errors')
...
def train_eval_period(verbose: bool = False) -> Tuple[float, List[float]]:
    ...
    if verbose:
        draw_error_plot(errors_list=errors_list, title='Elman_Jordan model on periodical sequence errors')
...
def train_eval_factorial(verbose: bool = False) -> Tuple[float, List[float]]:
    ...
    if verbose:
        draw_error_plot(errors_list=errors_list, title='Elman_Jordan model on factorial sequence errors')
...
def train_eval_exponent(verbose: bool = False) -> Tuple[float, List[float]]:
    ...
    if verbose:
        draw_error_plot(errors_list=errors_list, title='Elman_Jordan model on exponential sequence errors')
